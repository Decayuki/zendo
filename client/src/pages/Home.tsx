...
function Accueil() {
  ...
  return (
    <div className="accueil-container">
      {/* Provisoire en attendant composant header voir avec Marion */}
      <div className="accueil-header">
        <div className="accueil-logo">
          <span className="logo-text">Z</span>
        </div>
        <h1 className="accueil-title">ZENDO</h1>
      </div>

      {/* --- BARRE DE RECHERCHE — a decommenter quand le composant sera cree
